...
class UserRegistrationForm(UserCreationForm):
    ...
    password2 = forms.CharField(label= 'Conferm Password(again)', widget = forms.PasswordInput(attrs={'class': 'form-control'}))
...
class LoginForm(AuthenticationForm):
    username = UsernameField(widget = forms.TextInput(attrs={'autofocus':True, 'class': 'form-controls'}))
    password = forms.CharField(label= 'Password',strip=False, widget= forms.PasswordInput(attrs={'autofocus': True, 'class': 'form-controls'}))
